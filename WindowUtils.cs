...
// SOURCE: https://stackoverflow.com/questions/56481230/how-to-create-windows-10-acrylic-transparency-effect-in-winform-c-sharp
public static class WindowUtils
{
	...
	private static uint ToAbgr(Color color) { return((uint)color.A << 24) | ((uint)color.B << 16) | ((uint)color.G << 8) | color.R; }
